...
GSM, Battery and Display classes. Ensure all fields 
hold correct data at any given time.
*/

// Class data is already encapsulated through properties.
// Added some checks in getters and setters and
// handled exceptions
...
namespace _05.Encapsulation
{
    ...
    class ToStringOverride
    {
        static void Main()
        {
            ...
            // change numeric values to negatives to test exception handling
