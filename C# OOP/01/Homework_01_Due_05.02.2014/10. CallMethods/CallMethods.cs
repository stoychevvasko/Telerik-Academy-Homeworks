...
// Added methods starting from line 133

namespace _10.CallMethods
{
    ...
    class CallMethods
    {
        static void Main()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                uint duration = (uint)rand.Next(60);
            ...
            Console.Write("Press a key to clear Call History...");
            Console.ReadKey();
