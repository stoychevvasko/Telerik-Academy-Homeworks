namespace _03.ImplementIComparable
{
    ...
    public class Student
        : ICloneable, IComparable<Student>
    {
        #region fields
        ...
        public int CompareTo(Student other)
        {
            ...
            // if this code is reached, first names match
            ...
            // if this code is reached, middle names match
            ...
            // if this code is reached, last names match

            if (this.SSN != other.SSN)
            {
                int thisSSN = int.Parse(this.SSN);
                int otherSSN = int.Parse(other.SSN);
                
                return ((thisSSN - otherSSN) > 0?1:-1);
            }

            // if this code is reached, both instances are value-equal according to the criteria requirements
