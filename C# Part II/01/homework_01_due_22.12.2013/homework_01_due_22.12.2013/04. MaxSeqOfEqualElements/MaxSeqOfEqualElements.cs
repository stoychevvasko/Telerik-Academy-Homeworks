...
{    
    ...
    static public int NumberOfElementsInSequence(int[] array, int index, int arrayLength)
    {
        ...
        else
        {
            ...
            //     next element is equal to current element therefore 1 is added to the next 
            //     recursive instance; the addition ultimately results in the total number
            //     of equal elements in a sequence
        }      
    }
    ...
    static void Main()
    {
        ...
        Console.Title = "MaxSeqOfEqualElements";
        Console.ForegroundColor = ConsoleColor.Green;
        Console.Clear();


        Console.WriteLine();
        Console.WriteLine("  Write a program that finds the maximal sequence of");
        Console.WriteLine("  equal elements in an array.");
     ...
     //     ^ this array will contain the length of sequences of equal elements from the original array
     //     e.g. if the original array is, say, {1, 1, 1, 5, 8} then sequenceLengths would be {3, 2, 1, 1, 1} - 
     ...
     //     followed by none and is thus always a part of a single-element sequence by definition
        ...
        Console.WriteLine("  Here is the longest sequence of equal elements within the original array:");
        Console.WriteLine();
